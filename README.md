...
# Build contract
python -m py_near.compiler contract.py

# Run tests
pytest tests/

# Deploy to testnet
near deploy --accountId YOUR_ACCOUNT.testnet --wasmFile contract.wasm
```
...
# Deploy to testnet
near deploy --accountId YOUR_ACCOUNT.testnet --wasmFile target/wasm32-unknown-unknown/release/todo_contract.wasm
```
